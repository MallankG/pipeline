...
export default function EdaPage({ params }: { params: { id: string; versionId: string } }) {
    ...
    <main className="grid" style={{ gap: 20 }}>
      ...
      <section className="card">
        ...
        <div style={{ marginTop: 12, display: "flex", gap: 12 }}>
          <a className="btn secondary" href={`/datasets/${params.id}/curate/${params.versionId}`}>Back to Curation</a>
